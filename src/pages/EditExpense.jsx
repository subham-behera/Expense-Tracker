...
function EditExpense({ expense, onUpdateExpense, onClose }) {
  ...
  return (
    <div className="fixed top-0 left-0 bg-gradient-to-r from-violet-500 to-purple-500 w-screen h-screen flex justify-center items-center font-sans bg-black bg-opacity-50 z-50 p-2">
